                ...
                items: [
                    {
                        ...
                        name: 'sc_template', // identifier
                        label: 'Шаблон',
                        items: [
                            { text: 'Стандартный', value: 'standart'},
                            { text: 'Наши работы', value: 'out_work' }
                        ]
                    }, {
                        type: 'htmlpanel', // component type
                        html: '<p style="font-size: .75rem; margin-top: .25rem; margin-bottom: 1.25rem;">Выберите шаблон отображения галереи.</p>'
                    }, {
                        type: 'input',
                        name: 'section_title',
