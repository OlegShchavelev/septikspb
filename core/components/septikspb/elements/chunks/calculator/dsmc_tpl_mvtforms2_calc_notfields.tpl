    ...
    <form id="{$formID}_form" class="mvtForm2" method="post">
        ...
        <span class="input-group-text">
            <i class="far fa-user"></i>
                    ...
                    <input class="form-control form-control-lg" name="{$formID}_name" type="text"
        ...
        <div class="row align-items-center">
            <div class="form-group col-xl-8 mb-0">
                ...
                <label class="form-check-label text-dark" for="{$formID}_accept">
                    ...
                    <span>Я согласен с <a class="text-dark" href="{'340' | url}"
                                          rel="nofollow">политикой конфиденциальности</a></span>
                </label>
