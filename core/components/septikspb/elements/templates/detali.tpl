                        ...
                        *}
                        ...
                        <div class="t21_product_maininfo_price2_wr d-flex align-items-center">
                            ...
                            <a href="javascript:return" data-toggle="popover" title="Условия монтажа"
                               data-content="{(2 | dsmcGetResourceDepthId) | resource : 'tv_taxonomy_tooltips'}" data-html="true" class="ml-3 btn btn-light text-dark btn-icon-only rounded-circle"><i class="fas fa-question"></i></a>
                        </div>
