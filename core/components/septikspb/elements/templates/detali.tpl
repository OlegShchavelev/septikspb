                ...
                <div class="col-lg-{'ms_installment' | resource == 1 ? '8' : '12'}">
                    ...
                    <div class="page-title d-flex justify-content-between align-items-start align-items-lg-center">
                        ...
                        <div class="ya-share2" data-curtain data-shape="round" data-limit="0"
                             ...
                             data-services="messenger,vkontakte,facebook,odnoklassniki,telegram,viber,whatsapp"></div>
                    </div>
                </div>
                        ...
                        <div class="card border-0">
                            <div class="d-flex align-items-center justify-content-left  justify-content-md-end mt-4 mb-2 my-md-0">
                                ...
                                <div class="font-weight-semibold">Рассрочка <a href="{'587' | url}"
                                                                               class="text-decoration-none font-weight-bold">0%
                                        на все</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    <li class="list-inline-item">
                                        <a href="#" data-click data-data-list="default" class="msfavorites"
                                           ...
                                           data-data-pagetitle="{'pagetitle' | resource}"
                                           data-data-key="{'id' | resource}">
                        ...
                        <div class="card-body" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="text-xl text-dark font-weight-bold"
                                     itemprop="price">{$_pls['price']} {'ms2_frontend_currency' | lexicon}</div>
                                <span
                                        itemprop="priceCurrency" style="display:none;">RUB</span>
                                {if $_pls['old_price'] != 0}
                                    <div class="text-md text-danger font-weight-bold">
                                        <del>{$_pls['old_price']} {'ms2_frontend_currency' | lexicon}</del>
                                    </div>
                                {/if}
                            </div>
                            ...
                            <form method="post" class="ms2_form my-3">
                                <button class="btn btn-primary btn-block btn-lg btn-icon-label" type="submit"
                                        name="ms2_action"
                                        value="cart/add">
                                ...
                                *}
                                ...
                                <div class="t21_product_maininfo_price2_wr d-flex align-items-center">
                                    ...
                                    <a href="javascript:return" data-toggle="popover" title="Условия монтажа"
                                       data-content="{(2 | dsmcGetResourceDepthId) | resource : 'tv_taxonomy_tooltips'}"
                                       data-html="true"
                                       class="ml-3 btn btn-light text-dark btn-icon-only rounded-circle"><i
