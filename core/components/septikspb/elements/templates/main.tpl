...
<div class="header_slider new-header_slider">

    <div class="new_header_slider_wr">
        <ul>


            [[getImageList?
            &tvname=`migx_new_top_banner`
            &tpl=`migx_new_top_banner_tpl`
            &docid=`[[*id]]`
            &limit=`999`
            &wrapperTpl=`@CODE: [[+output]]`
            ]]


        </ul>
    </div>
    <div class="header_slider_pager container d-flex justify-content-center">
        <div class="row">
            <div class="col-xl-3"><a href="" data-slide-index="0"><i class="fa fa-2x fa-diamond"></i><span>Рассрочка</span></a></div>
            <div class="col-xl-3"><a href="" data-slide-index="1"><i class="fa fa-2x fa-gift"></i><span>Подарки</span></a></div>
            <div class="col-xl-3"><a href="" data-slide-index="2"><i class="fa fa-2x fa-shield"></i><span>Гарантия</span></a></div>
            <div class="col-xl-3"><a href="" data-slide-index="3"><i class="fa fa-2x fa-rub"></i><span>Лучшая цена</span></a></div>
        </div>
    </div>
</div>
</div>
...
<main>
    <div class="lb_index_1">
        <div class="container">
            ...
            <div class="real-content">
                ...
                <p>
                    СептикСервис – это команда опытных инженеров из Санкт-Петербурга, которая занимается проектированием и <br/>
                    установкой систем  <a href="[[~275]]" class="with_icon"><img src="img/ti1.png" alt="" />АВТОНОМНОЙ КАНАЛИЗАЦИИ</a> и <a href="[[~274]]" class="with_icon"><img src="img/ti2.png" alt="" />СЕПТИКОВ</a>.    Применяемые технологии, <br/>
                    теоретическая подготовка и многолетний опыт позволяют нам решать проблемы отсутствия центрального <br/>
                    ...
                    <a href="[[~312]]" class="with_icon"><img src="img/ti4.png" alt="" />
                        С ЭЛЕКТРИЧЕСТВОМ</a>  и <a class="with_icon" href="[[~325]]"><img src="img/ti5.png" alt="" />БЕЗ ЭЛЕКТРИЧЕСТВА</a> <br/>
                    Используя продукцию ведущих производителей систем ЛОС и станций биологической <br/> очистки,разрабатываем проекты на
    ...
    <div class="lb_index_2">
        <div class="container">
            ...
            <div class="real-content">
                <p>За десять лет работы по организации канализаций для частных домов мы выработали выгодные и гибкие по цене комплексные предложения «под ключ». Они подходят для большинства наших клиентов.<br><br></p>
            </div>
            ...
            <p><br><br>Вы можете выбрать наиболее подходящее для вас предложение по количеству жильцов в доме и оставить заявку на нашем сайте. Мы обеспечим бесплатный выезд нашего замерщика. Он оценит фронт работ, а вы сделаете окончательный выбор.</p>
        </div>
    </div>
    <div class="lb_index_3">
        <div class="container">
            <h2 class="lb_title">Только лучшие септики и канализация</h2>
            <p>Наши партнеры – это проверенные производители систем автономной канализации и септиков. Наша компания прочно заняла свою нишу на рынке продажи, проектирования и монтажа ЛОС. Это стало возможно благодаря качеству продукции партнеров компании, отличном сервису и длительной гарантии.<br><br></p>
            <div class="product_filter_wr">
                <div class="product_filter_triggers">
                    ...
                    <div class="product_filter_trigger" data-type="stekloplast" data-link="[[~56]]">Септики из стеклопластика</div>
            ...
            <div class="real_content">
                <p>Мы являемся официальным дилером самых надежных на рынке производителей ЛОС. СептикСервис предлагает вам самые выгодные условия продажи и установки оборудования наших партнеров в Санкт-Петербурге!</p>
            </div>
        </div>
    </div>
    [[!bottomAdd?&input=`
    ...
    <div class="lb_index_4">
        <div class="container">
            ...
            <div class="real_content">
                <p>Наша компания - это высокое качество услуг и прозрачные цены. Мы с удовольствием проводим для наших клиентов подробные консультации. Мы подберем оптимальное оборудование, спроектируем канализационныю систему, а также сохраним баланс природы и технологий на участке.</p>
            </div>
            <div class="lb4_wr">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="lb4_item">
                            <div class="lb4_item_main" style="background-image:url('css/images/icon_cbm.png')">&nbsp;</div>
    ...
    <div class="lb_index_5">
        <div class="container">
            ...
            <div class="real_content">
                <p>Наша компания всегда работает только по официальному договору. Мы пользуемся собственными постоянными бригадами компании. Они обладают необходимой специализацией, опытом по качественному обустройству автономных канализаций на частных участках.</p>
            </div>
            <div class="lb5_wr">
            ...
            <div class="lb_button_t1_wr">
                <a data-fancybox data-src="#mounting-form" class="lb_button_t1 lb_button_t1_worker" href="javascript:;" href=""><span>Заказать выезд инженера</span></a>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-tr">
                    ...
                    <div class="col-xs-td lb6_right">
                        <div class="real_content">
                            ...
                            <p>Мы разработали и воплотили в жизнь <strong>более 1500 проектов по всему Северо-Западу</strong>. Сотрудничество с нами - это специальные проекты для всех и каждого. Эффективное финансовое вложение, учет всех ваших пожеланий, безупречное гарантийное обслуживание - это СептикСервис!</p>
                            <p>Мы постоянно отслеживаем новые предложения от производителей, тенденции рынка и потребностей наших клиентов. Таким образом мы предлагаем только самые современные инженерные решения, которые бесперебойно прослужат вам долгое время. Портфолио компании подтверждает наш огромный опыт, тщательность монтажа, а также в обширную географию нашего бизнеса. Мы производим монтаж и доставку по <strong>Ленинградской, Псковской, Новгородской области, Карелии</strong></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="real_content">
                        <p>Начиная с 2010 года, мы накопили бесценный опыт. <strong>Мы установили более 1500 канализаций и септиков</strong> в загородных домах наших клиентов. Мы понимаем, что канализация из бетонных колец, сделанная своими руками - прошлый век. Полноценная система очистки стоков - это уже стандарт жизни, который быстро входит в нашу жизнь, меняя образ мышления в сторону экологии.</p>
                        <p>Нам не нужна агрессивная реклама – <strong>нас рекомендуют</strong>, ведь мы предлагаем только честные цены на весь каталог товаров. Мы регулярно устраиваем акции, не забывая про качество монтажа! <strong>Мы - ответственный и надежный подрядчик.</strong></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="real_content">
                        <p>Мы постоянно работаем над расширением ассортимента септиков и станций очистки. Добавляем в наш каталог востребованное оборудование из полиэтилена, полипропилена, стеклопластика. Поэтому вопрос <strong>«Какой септик купить?»</strong> лучше доверить нам. Иначе вы рискуете впустую потратить время и силы на изучение информации в интернете и, скорее всего, не получить ответа.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lb_index_8">
        <div class="container">
            <div class="lb8_content">
                <img src="css/images/icon_lb8_serv.png" alt=""><span>Сервисная служба работает без выходных и праздников</span>
            </div>
        </div>
    </div>
</main>
