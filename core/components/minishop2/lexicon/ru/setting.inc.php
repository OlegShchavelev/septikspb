...
$_lang['setting_ms2_product_as_uri'] = 'Настройка пользовательского URI товара';
$_lang['setting_ms2_product_as_uri_desc'] = 'Сформируйте URI: пример product/{alias} . Переменные псевдонима {id},{alias} .';